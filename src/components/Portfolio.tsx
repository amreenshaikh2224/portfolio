...
const projects = [
  {
    ...
    description: 'Analyzed raw data using SQL queries to identify trends, patterns, and insights for decision-making.',
    category: 'SQL',
    icon: Database,
  ...
  },
  {
    ...
    description: 'Cleaned and prepared data by handling missing values, duplicates, and inconsistencies for accurate analysis.',
    category: 'SQL',
    icon: Database,
  ...
  },
  {
    ...
    description: 'Built interactive dashboards to visualize KPIs and key insights in a clear, user-friendly way.',
    category: 'Tableau',
    icon: BarChart2,
  ...
  },
  {
    ...
    description: 'Created dynamic reports with data modeling and visuals to track performance and support business goals.',
    category: 'Power BI',
    icon: LineChart,
  ...
  },
  {
    ...
    description: 'Automated data processing and analysis, performed data visualization, and generated actionable insights.',
    category: 'Python',
    icon: Code2,
